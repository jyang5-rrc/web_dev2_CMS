...
<div class="container-fluid">
    <?php include('admin-nav-asider.php'); ?>
        <div class="col py-3">
            ...
            <div class="container">
                <h3>Product List</h3>
                <p>Here you can add, edit, delete product information.</p>
                        ...
                        <?php foreach ($result as $row): ?>
                            ...
                            <div class="card" style="width: 25%; padding-right:10px;padding-left: 10px; " >
                                ...
                                <div class="card-body">
                                    ...
                                    <p><a href="product-detail.php?id=<?php echo $id; ?>" class="btn btn-primary" role="button">View</a>
                                        <a href="edit-product.php?id=<?php echo $id; ?>" class="btn btn-default" role="button" >Edit</a>
                                        <a href="delete-product.php?id=<?php echo $id; ?>" class="btn btn-default" role="button">Delete</a>
                                        <?php if($top_sales): ?>
